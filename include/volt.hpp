...
extern "C" VOLT_API_EXPORT byte* volt_virtual_machine_get_registers(VirtualMachine* vm, uint64_t* size);
...
extern "C" VOLT_API_EXPORT bool volt_stack_push(Stack* stack, byte* data, Type type, uint64_t* stackOffset);
...
extern "C" VOLT_API_EXPORT byte* volt_stack_get_buffer(Stack* stack);
extern "C" VOLT_API_EXPORT byte* volt_stack_get_top(Stack* stack);
